...
function isCustom(element) {
  return Boolean(window.customElements.get(
      mapComponentToTag_1.mapComponentToTag(element.constructor)));
}
...
function isNative(element) {
  return element.constructor.name in globalThis &&
 ...
 * @param element
 */
function isText(element) { return element.constructor === Text; }
