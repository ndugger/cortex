...
function createDocumentNode(element) {
    ...
    if (Element_1.Element.isNative(element)) {
         ...
         */
        if ((element.constructor === HTMLElement || element.constructor === SVGElement) && !((_b = (_a = element) === null || _a === void 0 ? void 0 : _a.properties) === null || _b === void 0 ? void 0 : _b.tag)) {
        ...
        if (element.constructor.name in HTML_CLASS_NAME_LOOKUP) {
            ...
            node = window.document.createElement((_d = (_c = element.properties) === null || _c === void 0 ? void 0 : _c.tag) !== null && _d !== void 0 ? _d : mapComponentToTag_1.mapComponentToTag(HTMLUnknownElement));
        }
        else if (element.constructor.name.startsWith('HTML')) {
            if ((_e = element === null || element === void 0 ? void 0 : element.properties) === null || _e === void 0 ? void 0 : _e.tag) {
            ...
            node = window.document.createElementNS(SVG_NAMESPACE, (_g = (_f = element.properties) === null || _f === void 0 ? void 0 : _f.tag) !== null && _g !== void 0 ? _g : mapComponentToTag_1.mapComponentToTag(HTMLUnknownElement));
        }
        else if (element.constructor.name.startsWith('SVG')) {
            if (element.properties && 'tag' in element.properties) {
                node = window.document.createElementNS(SVG_NAMESPACE, (_j = (_h = element.properties) === null || _h === void 0 ? void 0 : _h.tag) !== null && _j !== void 0 ? _j : mapComponentToTag_1.mapComponentToTag(HTMLUnknownElement));
            }
