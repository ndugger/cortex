...
export function connect(element, host) {
    ...
    if (element.properties)
        for (const option of Object.keys(element.properties)) {
            if (option === 'namespaces')
                for (const [name, space] of Object.entries(element.properties[option])) {
            ...
            if (option === 'attributes') {
                ...
                for (const [attribute, object] of Object.entries(element.properties.attributes)) {
                    ...
                    if (typeof object === 'object')
                        ...
                        element.node.setAttribute(attribute, object);
                    }
                    continue;
                }
                continue;
