...
function mergeTreeChanges(existing, incoming) {
  ...
  for (let index = 0; index < Math.max(existing.length, incoming.length);
    ...
    if (!incomingElement) {
      ...
      if (Component_1.Component.isComponent(existingElement.node) ||
          Fragment_1.Fragment.isFragment(existingElement.node)) {
        existingElement.node.remove();
      } else {
        (_b = (_a = existingElement.node) === null || _a === void 0
                  ? void 0
                  : _a.parentNode) === null ||
                _b === void 0
            ? void 0
            : _b.removeChild(existingElement.node);
      }
      continue;
    }
    /**
    ...
    if (existingElement.constructor !== incomingElement.constructor) {
      ...
      if (Component_1.Component.isComponent(existingElement.node) ||
        ...
        (_d = (_c = existingElement.node) === null || _c === void 0
                  ? void 0
                  : _c.parentNode) === null ||
                _d === void 0
            ? void 0
            : _d.removeChild(existingElement.node);
      }
    } else {
      outgoing.push(Object.assign(existingElement, {
        children : mergeTreeChanges(existingElement.children,
