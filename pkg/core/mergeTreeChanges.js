...
function mergeTreeChanges(existing, incoming) {
    ...
    for (
        ...
        if (!incomingElement) {
            ...
            if (
                Component_1.Component.isComponent(existingElement.node) ||
                Fragment_1.Fragment.isFragment(existingElement.node)
            ) {
                existingElement.node.remove();
            } else {
                (_b =
                    (_a = existingElement.node) === null || _a === void 0
                        ? void 0
        ...
        if (existingElement.constructor !== incomingElement.constructor) {
            ...
            if (
                ...
                (_d =
                    (_c = existingElement.node) === null || _c === void 0
                        ? void 0
                        : _c.parentNode) === null || _d === void 0
                    ? void 0
