...
function connectElementToHost(element, host) {
  ...
  } else if ((Element_1.Element.isNative(element) ||
              Element_1.Element.isCustom(element)) &&
             element.properties) {
    for (const property of Object.keys(element.properties)) {
      ...
      if (property === 'namespaces') {
        for (const [name, space] of Object.entries(
                 (_a = element.properties[property]) !== null && _a !== void 0
                     ? _a
                     : {})) {
          (_b = element.node) === null || _b === void 0
              ? void 0
              : _b.setAttributeNS(XML_NAMESPACE, `xmlns:${name}`, space);
        }
      }
      /**
      ...
      if (property === 'attributes') {
        for (const attribute of Array.from(
                 (_d = (_c = element.node) === null || _c === void 0
                           ? void 0
                           : _c.attributes) !== null &&
                         _d !== void 0
                     ? _d
          ...
          if (!(attribute.name in
                ((_e = element.properties[property]) !== null && _e !== void 0
                     ? _e
                     : {})) ||
              Reflect.get((_f = element.properties[property]) !== null &&
                                  _f !== void 0
                              ? _f
                              : {},
        ...
        for (const [attribute, object] of Object.entries(
                 (_g = element.properties[property]) !== null && _g !== void 0
                     ? _g
                     : {})) {
          /**
           ...
           */
          if (object === true) {
            (_h = element.node) === null || _h === void 0
                ? void 0
                : _h.setAttribute(attribute, '');
          }
          /**
          ...
          if (typeof object === 'object')
            for (const [key, value] of Object.entries(object)) {
               ...
               */
              if ('namespaces' in element.properties &&
                  attribute in
                      ((_k = (_j = element.properties) === null || _j === void 0
                                 ? void 0
                                 : _j.namespaces) !== null &&
                               _k !== void 0
                           ? _k
                ...
                element.node.setAttributeNS(
                    ((_m = (_l = element.properties) === null || _l === void 0
                               ? void 0
                               : _l.namespaces) !== null &&
                             _m !== void 0
                         ? _m
                ...
                if (root) {
                  element.node.setAttributeNS(
                      root.getAttribute(`xmlns:${attribute}`),
                      `${attribute}:${key}`, String(value));
                } else {
      ...
      if (element.node[property] &&
          typeof element.node[property] === 'object' &&
          !Array.isArray(element.properties[property])) {
  ...
  if (Element_1.Element.isNative(element) &&
      !element.node.classList.contains(element.constructor.name)) {
