...
function connectElementToHost(element, host) {
    ...
    if (Element_1.Element.isText(element)) {
        ...
        (Element_1.Element.isNative(element) ||
        ...
        for (const property of Object.keys(element.properties)) {
            ...
            if (property === "namespaces") {
                for (const [name, space] of Object.entries(
                    (_a = element.properties[property]) !== null &&
                        _a !== void 0
                        ? _a
                        : {}
                )) {
            ...
            if (property === "attributes") {
                for (const attribute of Array.from(
                    (_d =
                        (_c = element.node) === null || _c === void 0
                            ? void 0
                            : _c.attributes) !== null && _d !== void 0
                        ? _d
                        : []
                )) {
                    /**
                    ...
                    if (
                        !(
                            attribute.name in
                            ((_e = element.properties[property]) !== null &&
                            _e !== void 0
                                ? _e
                                : {})
                        ) ||
                        Reflect.get(
                            (_f = element.properties[property]) !== null &&
                                _f !== void 0
                                ? _f
                                : {},
                            attribute.name
                ...
                for (const [attribute, object] of Object.entries(
                    (_g = element.properties[property]) !== null &&
                        _g !== void 0
                        ? _g
                        : {}
                )) {
                    ...
                    if (typeof object === "object")
                        for (const [key, value] of Object.entries(object)) {
                             ...
                             */
                            if (
                                "namespaces" in element.properties &&
                                attribute in
                                    ((_k =
                                        (_j = element.properties) === null ||
                                        _j === void 0
                                            ? void 0
                                            : _j.namespaces) !== null &&
                                    _k !== void 0
